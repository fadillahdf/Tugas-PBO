...
class Dashboard:
    ...
    def __init__(self):
        ...
        self.admin_menu.add_command(label='Admin-persegi', command=lambda: self.new_window("Luas Persegi", FrmPersegi))
        self.admin_menu.add_command(label='Admin-segitiga', command=lambda: self.new_window("Luas Segitiga", FrmSegitiga))
        self.admin_menu.add_command(label='Admin-lingkaran', command=lambda: self.new_window("Luas Lingkaran", FrmLingkaran))
        ...
        self.dosen_menu.add_command(label='Dosen-persegi', command=lambda: self.new_window("Luas Persegi", FrmPersegi))
        self.dosen_menu.add_command(label='Dosen-segitiga', command=lambda: self.new_window("Luas Segitiga", FrmSegitiga))
        self.dosen_menu.add_command(label='Dosen-lingkaran', command=lambda: self.new_window("Luas Lingkaran", FrmLingkaran))
